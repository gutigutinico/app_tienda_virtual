    ...
    if (control_envio == true) {
        ...
        axios({
            ...
            if (response.data.message.indexOf("No se puedo enviar") === -1 && response.data.message.indexOf("Los datos no son valido") == -1) {
                appendAlert("📧 " + response.data.message, "success", "liveAlertPlaceholder")
                ...
                appendAlert("📧 " + response.data.message, "danger", "liveAlertPlaceholder")
            }
            ...
            control_envio = true
            document.querySelector("#enviar_correo").classList.remove("disabled")
            appendAlert("📧 " + error.response.data.message, "danger", "liveAlertPlaceholder")
        });
    }
})
